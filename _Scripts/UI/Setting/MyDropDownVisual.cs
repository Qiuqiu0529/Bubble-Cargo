...
public class MyDropDownVisual : UIControlVisuals
{
    ...
    public void HandleOptionSelected(Gesture.OnClick evt, ToggleVisuals option, int index)
    {
        ...
        if (index != DataSource.SelectedIndex)
        {
            ...
            SelectionLabel.Text =textMgr.GetText(DataSource.CurrentSelection);
    ...
    public void InitSelectionLabel(string label)
    {
        ...
        SelectionLabel.Text = textMgr.GetText(label);
    }
    ...
    private void BindOption(Nova.Data.OnBind<string> evt, ToggleVisuals option, int index)
    {
        ...
        option.Label.Text = textMgr.GetText(evt.UserData);
